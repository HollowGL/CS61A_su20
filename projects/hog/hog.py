...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    add_pots0, add_pots1 = 0, 0
    bonus = 0
    while score0 < goal and score1 < goal:
        if who == 0:
            if feral_hogs and abs(strategy0(score0, score1) - add_pots0) == 2:
                bonus = 3

            add_pots0 = take_turn(strategy0(score0, score1), score1, dice)
            score0 = score0 + add_pots0 + bonus
            bonus = 0
            ...
            if feral_hogs and abs(strategy1(score1, score0) - add_pots1) == 2:
                bonus = 3

            add_pots1 = take_turn(strategy1(score1, score0), score0, dice)
            score1 = score1 + add_pots1 + bonus
            bonus = 0
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    old_max_scoring_roll = 0
    for number_rolls in range(10, 0, -1):
        new_max_scoring_roll = make_averaged(roll_dice, trials_count)(number_rolls, dice)
        if new_max_scoring_roll >= old_max_scoring_roll:
            old_max_scoring_roll = new_max_scoring_roll
            max_scoring_number_rolls = number_rolls
    return max_scoring_number_rolls
